...
public class CreateRouteImportPreviewRequest {
    ...
    public Boolean getUseTolls() { return useTolls; }
    public void setUseTolls(Boolean useTolls) { this.useTolls = useTolls; }

    public Boolean getUseHighways() { return useHighways; }
    public void setUseHighways(Boolean useHighways) { this.useHighways = useHighways; }

    public Boolean getUseTraffic() { return useTraffic; }
    public void setUseTraffic(Boolean useTraffic) { this.useTraffic = useTraffic; }

    public RouteOptimizationTypeEnum getOptimizationType() { return optimizationType; }
    public void setOptimizationType(RouteOptimizationTypeEnum optimizationType) { this.optimizationType = optimizationType; }

    public NavigationProviderEnum getNavigationProvider() { return navigationProvider; }
    public void setNavigationProvider(NavigationProviderEnum navigationProvider) { this.navigationProvider = navigationProvider; }
